...
This repo is forked and edited from [Leonid Keselman's website](https://leonidk.com/) and [repo](https://github.com/leonidk/new_website).
...
* I use thumbnails, so I can upload arbitrary sized images but then only display small ones. The `_make_thumbnails.sh` script generates them and the html template looks in `images/` for all images. 
